...
def registrarme(request):
    ...
    if request.method == 'POST':
        ...
        if form_usuario.is_valid() and form_perfil.is_valid():
            ...
            perfil.save()
            #premium = ' y aprovechar tus descuentos especiales  como cliente PREMIUM' if perfil.save
...
def ventas(request):
    ...
    for boleta in boletas:
        boleta_historial ={
            ...
            'suscrito' : 'Sí' if boleta.cliente.subscrito else 'No',
...
def enviar_correo_cambio_password(request, user, password):
    try:
        ...
        subject = 'Cambio de contraseña electroniks'
        ...
        from_email = 'info@electroniks.com'  # La dirección de correo que aparecerá como remitente
        recipient_list = []
